...
COPY --from=builder /go/src/github.com/k8-proxy/go-k8s-process/dep/libglasswall.classic.so usr/lib/libglasswall.classic.so
COPY --from=builder /go/src/github.com/k8-proxy/go-k8s-process/dep/glasswallCLI /dep/glasswallCLI
